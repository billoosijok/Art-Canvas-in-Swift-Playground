...
public class InteractiveCanvas: UIViewController {
    ...
    let undoImage : UIImage = UIImage(named: "undo")!
    ...
    private func initUI() {
        ...
        shapeMarginSlider = UISlider(frame: CGRect(x: 0, y: 0, width: 60, height: 30))
        
        shapeRadiusSlider = UISlider(frame: CGRect(x: 0, y: 0, width: 60, height: 30))
